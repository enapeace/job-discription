...
- `company_info`는 로그인을 해야 볼 수 있음. 나중에 구현 예정
...
```json
  ...
  직무: {title}
  직무카테고리: {job_category}
  기술스택: {job_description['기술스택']}
  주요업무: {job_description['주요업무']}
  자격요건: {job_description['자격요건']}
  우대사항: {job_description['우대사항']}
  회사 특징: {', '.join(company_tags)}
  """
```
---
